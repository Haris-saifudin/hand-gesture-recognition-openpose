        ...
        if (datumsPtr != nullptr && !datumsPtr->empty())
        {
            ...
            if (!cvMat.empty())
            {
                ...
                if (numberPeopleDetected != 0) {
                    ...
                    //RIGHT WRIST
                    /*int rightWrist_x1 = datumsPtr->at(0)->poseKeypoints[21] + 40;
                    int rightWrist_y1 = datumsPtr->at(0)->poseKeypoints[22] + 40;
                    int rightWrist_x2 = datumsPtr->at(0)->poseKeypoints[21] - 40;
                    int rightWrist_y2 = datumsPtr->at(0)->poseKeypoints[22] - 60;*/

                    /*int stomatch = datumsPtr->at(0)->poseKeypoints[4] + 60;
                    int rightWrist = datumsPtr->at(0)->poseKeypoints[22];*/
                    /* std::cout << "Right Wrist = " << rightWrist << std::endl
                         << "Stomatch =" << stomatch << std::endl;*/

                         //std::cout << pt1x << "-" << pt1y << "|" << pt2x << "-" << pt2y << std::endl;
                    if (datumsPtr->at(0)->poseKeypoints[22] - 60 > 0 && datumsPtr->at(0)->poseKeypoints[21] - 40 > 0) {
                        if (datumsPtr->at(0)->poseKeypoints[22] + 40 < HEIGHT_WINDOWS && datumsPtr->at(0)->poseKeypoints[21] + 40 < WIDTH_WINDOWS) {
                            //std::cout << rightWrist_x1 << ":" << rightWrist_y1 << "|" << rightWrist_x2 << ":" << rightWrist_y2  << std::endl;

                            if (datumsPtr->at(0)->poseKeypoints[4] + 60 > datumsPtr->at(0)->poseKeypoints[22]) {
                                cv::Rect Rec(datumsPtr->at(0)->poseKeypoints[21] - 40, datumsPtr->at(0)->poseKeypoints[22] - 40, 80, 80);
                                ...
                                cv::Rect Rec(datumsPtr->at(0)->poseKeypoints[21] - 40, datumsPtr->at(0)->poseKeypoints[22] - 40, 80, 80);
                                cv::rectangle(Img, Rec, cv::Scalar(0, 0, 255), 5, 8, 0);
                                cv::Mat Roi = Img(Rec);
                                counterImg++;
                            }
...
int Openpose()
{
    try
    {
        ...
        while (true) {
            ...
            face_cascade.detectMultiScale(frame_gray, faces, 2.1, 3, 0, cv::Size(40, 40));
            std::cout << std::endl;
